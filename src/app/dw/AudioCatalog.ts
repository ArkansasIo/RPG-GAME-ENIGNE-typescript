...
export const createAudioCatalog = (): AudioCue[] => [
    ...
    { id: 'sound-quest-start', kind: 'sound', label: 'Quest Start', file: 'quest_start.wav', description: 'Quest activation signal.' },
    { id: 'sound-quest-complete', kind: 'sound', label: 'Quest Complete', file: 'quest_complete.wav', description: 'Triumphant mission finish.' },
    { id: 'sound-footstep-grass', kind: 'sound', label: 'Footstep Grass', file: 'footstep_grass.wav', description: 'Soft field movement.' },
    { id: 'sound-footstep-stone', kind: 'sound', label: 'Footstep Stone', file: 'footstep_stone.wav', description: 'Dungeon stone steps.' },
    ...
    { id: 'sound-weapon-echo', kind: 'sound', label: 'Weapon Echo', file: 'weapon_echo.wav', description: 'Afterimage strike.' },
    { id: 'sound-shadow-breath', kind: 'sound', label: 'Shadow Breath', file: 'shadow_breath.wav', description: 'Dark creature breath.' },
